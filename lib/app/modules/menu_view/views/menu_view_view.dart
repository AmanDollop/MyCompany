            ...
            return ModalProgress(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Obx(() => controller.menusModal.value != null
            ...
            child: Ink(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: Center(
                      child: CW.commonNetworkImageView(
                        isAssetImage: false,
                        path:
                        controller.searchController.text.isNotEmpty?'${AU.baseUrlForSearchCompanyImage}${controller.getMenuListForSearch[index].menuImage}':'${AU.baseUrlForSearchCompanyImage}${controller.getMenuList[index].menuImage}',
                        width: 34.px,
                        height: 34.px,
                      ),
                    ),
                  ...
                  Flexible(
                    child: cardTextView(
                      text: controller.searchController.text.isNotEmpty?'${controller.getMenuListForSearch[index].menuName}':'${controller.getMenuList[index].menuName}',
                    ),
                  ),
                ],
              ),
