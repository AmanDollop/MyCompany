...
class AddLeaveView extends GetView<AddLeaveController> {
            ...
            child: Card(
              ...
              child: SizedBox(
                ...
                child: Center(
                  child: Text(
                    day.toString(),
                    style: Theme.of(Get.context!).textTheme.labelSmall?.copyWith(fontWeight: FontWeight.w600, fontSize: 10.px,
                        color: controller.dateAddForLeaveList.contains('$day ${CMForDateTime.dateFormatForMonthYear(date: '${controller.currentMonth.value}')}')
                            ? Col.inverseSecondary
                            : Col.text),
                  ),
  ...
  Widget leaveDateGridView() => Container(
            ...
            children: [
              CW.commonRadioView(
                onChanged: (value) {
                  ...
                  controller.fullAndHalfDayType.value = controller.fullAndHalfDayText[index];
                  controller.count.value++;
                },
                index: index.toString(),
                selectedIndex: controller.fullAndHalfDayIndexValue.value.toString(),
              ),
              radioButtonLabelTextView(text: controller.fullAndHalfDayText[index])
            ],
          );
        },
        itemCount: 2,
            ...
            children: [
              CW.commonRadioView(
                onChanged: (value) {
                  ...
                  controller.firstAndSecondHalfType.value = controller.firstAndSecondHalfText[index];
                  controller.count.value++;
                },
                index: index.toString(),
                selectedIndex: controller.firstAndSecondHalfIndexValue.value.toString(),
              ),
              radioButtonLabelTextView(text: controller.firstAndSecondHalfText[index])
            ],
          );
        },
        itemCount: 2,
            ...
            children: [
              CW.commonRadioView(
                onChanged: (value) {
                  ...
                  controller.paidAndUnPaidType.value = controller.paidAndUnPaidText[index];
                  controller.count.value++;
                },
                index: index.toString(),
                selectedIndex: controller.paidAndUnPaidIndexValue.value.toString(),
              ),
              radioButtonLabelTextView(text: controller.paidAndUnPaidText[index])
            ],
          );
        },
        itemCount: 2,
