...
class WorkReportView extends GetView<WorkReportController> {
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  controller.workReportList[index].workReport != null && controller.workReportList[index].workReport!.isNotEmpty
                                                      ...
                                                      : 'Data not found!',
                                                  style: Theme.of(context).textTheme.labelMedium?.copyWith(fontWeight: FontWeight.w500, fontSize: 10.px),
                                                  maxLines: 1,
                                                ...
                                                Text(
                                                  ...
                                                  style: Theme.of(context).textTheme.labelSmall?.copyWith(fontWeight: FontWeight.w500, fontSize: 10.px),
                                                ),
                                              ],
                                            ),
                                          ),
  ...
  Widget addWorkReportFloatingActionButtonView() => Padding(
    padding: EdgeInsets.only(bottom: 10.px),
    child: CW.commonOutlineButton(
        onPressed: () => controller.clickOnAddWorkReportButton(),
        child: Icon(
          Icons.add,
