                  ...
                  child: (index) {
                    ...
                    return SizedBox(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          onTap: () {
                            controller.branchIndexValue.value = controller.branchList[index].toString();
                            controller.count.value++;
                          },
                          ...
                          child: Ink(
                            ...
                            decoration: BoxDecoration(
                              color: controller.branchIndexValue.value == controller.branchList[index].toString()
                            ...
                            child: Row(
                              ...
                              children: [
                                Flexible(
                                  child: cardTextView(
                                    text: controller.branchList[index],
                                  ),
                                ),
                                CW.commonRadioView(
                                  onChanged: (value) {
                                    CM.unFocusKeyBoard();
                                    controller.branchIndexValue.value = value ?? '';
                                    controller.count.value++;
                                  },
                                  index: controller.branchList[index].toString(),
